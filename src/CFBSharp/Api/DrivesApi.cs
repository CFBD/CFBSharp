...
namespace CFBSharp.Api
{
    ...
    public interface IDrivesApi : IApiAccessor
    {
        ...
        ApiResponse<ICollection<Drive>> GetDrivesWithHttpInfo (int? year, string seasonType = null, int? week = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, string classification = null);
        ...
        System.Threading.Tasks.Task<ICollection<Drive>> GetDrivesAsync (int? year, string seasonType = null, int? week = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, string classification = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<Drive>>> GetDrivesAsyncWithHttpInfo (int? year, string seasonType = null, int? week = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, string classification = null);
    ...
    public partial class DrivesApi : IDrivesApi
    {
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>ICollection&lt;Drive&gt;</returns>
        public ICollection<Drive> GetDrives (int? year, string seasonType = null, int? week = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, string classification = null)
        {
             ApiResponse<ICollection<Drive>> localVarResponse = GetDrivesWithHttpInfo(year, seasonType, week, team, offense, defense, conference, offenseConference, defenseConference, classification);
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;Drive&gt;</returns>
        public ApiResponse< ICollection<Drive> > GetDrivesWithHttpInfo (int? year, string seasonType = null, int? week = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, string classification = null)
        {
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>Task of ICollection&lt;Drive&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<Drive>> GetDrivesAsync (int? year, string seasonType = null, int? week = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, string classification = null)
        {
             ApiResponse<ICollection<Drive>> localVarResponse = await GetDrivesAsyncWithHttpInfo(year, seasonType, week, team, offense, defense, conference, offenseConference, defenseConference, classification);
             return localVarResponse.Data;
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;Drive&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<Drive>>> GetDrivesAsyncWithHttpInfo (int? year, string seasonType = null, int? week = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, string classification = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling DrivesApi->GetDrives");
