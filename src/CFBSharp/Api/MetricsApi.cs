...
namespace CFBSharp.Api
{
    ...
    public interface IMetricsApi : IApiAccessor
    {
        ...
        ApiResponse<ICollection<GamePPA>> GetGamePPAWithHttpInfo (int? year, int? week = null, string team = null, string conference = null, bool? excludeGarbageTime = null);
        /// <summary>
        ...
        ApiResponse<ICollection<PlayerGamePPA>> GetPlayerGamePPAWithHttpInfo (int? year = null, int? week = null, string team = null, string position = null, int? playerId = null, string threshold = null, bool? excludeGarbageTime = null);
        /// <summary>
        ...
        /// <param name="adjustForSpread">Toggles pregame spread adjustments (optional, default to true)</param>
        ...
        ApiResponse<ICollection<PlayWP>> GetWinProbabilityDataWithHttpInfo (int? gameId, bool? adjustForSpread = null);
        ...
        System.Threading.Tasks.Task<ICollection<GamePPA>> GetGamePPAAsync (int? year, int? week = null, string team = null, string conference = null, bool? excludeGarbageTime = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<GamePPA>>> GetGamePPAAsyncWithHttpInfo (int? year, int? week = null, string team = null, string conference = null, bool? excludeGarbageTime = null);
        /// <summary>
        /// Get player game averages for Predicted Points Added (PPA)
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ICollection<PlayerGamePPA>> GetPlayerGamePPAAsync (int? year = null, int? week = null, string team = null, string position = null, int? playerId = null, string threshold = null, bool? excludeGarbageTime = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<PlayerGamePPA>>> GetPlayerGamePPAAsyncWithHttpInfo (int? year = null, int? week = null, string team = null, string position = null, int? playerId = null, string threshold = null, bool? excludeGarbageTime = null);
        /// <summary>
        /// Get player season averages for Predicted Points Added (PPA)
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ICollection<PlayWP>> GetWinProbabilityDataAsync (int? gameId, bool? adjustForSpread = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<PlayWP>>> GetWinProbabilityDataAsyncWithHttpInfo (int? gameId, bool? adjustForSpread = null);
    ...
    public partial class MetricsApi : IMetricsApi
    {
        ...
        /// <summary>
        /// Get team game averages for Predicted Points Added (PPA) Predicted Points Added (PPA) by game
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter</param>
        /// <param name="week">Week filter (optional)</param>
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>ICollection&lt;GamePPA&gt;</returns>
        public ICollection<GamePPA> GetGamePPA (int? year, int? week = null, string team = null, string conference = null, bool? excludeGarbageTime = null)
        {
             ApiResponse<ICollection<GamePPA>> localVarResponse = GetGamePPAWithHttpInfo(year, week, team, conference, excludeGarbageTime);
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;GamePPA&gt;</returns>
        public ApiResponse< ICollection<GamePPA> > GetGamePPAWithHttpInfo (int? year, int? week = null, string team = null, string conference = null, bool? excludeGarbageTime = null)
        {
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>Task of ICollection&lt;GamePPA&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<GamePPA>> GetGamePPAAsync (int? year, int? week = null, string team = null, string conference = null, bool? excludeGarbageTime = null)
        {
             ApiResponse<ICollection<GamePPA>> localVarResponse = await GetGamePPAAsyncWithHttpInfo(year, week, team, conference, excludeGarbageTime);
             return localVarResponse.Data;
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;GamePPA&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<GamePPA>>> GetGamePPAAsyncWithHttpInfo (int? year, int? week = null, string team = null, string conference = null, bool? excludeGarbageTime = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling MetricsApi->GetGamePPA");
        ...
        /// <summary>
        /// Get player game averages for Predicted Points Added (PPA) Predicted Points Added (PPA) by player game
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter (optional)</param>
        /// <param name="week">Week filter (optional)</param>
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>ICollection&lt;PlayerGamePPA&gt;</returns>
        public ICollection<PlayerGamePPA> GetPlayerGamePPA (int? year = null, int? week = null, string team = null, string position = null, int? playerId = null, string threshold = null, bool? excludeGarbageTime = null)
        {
             ApiResponse<ICollection<PlayerGamePPA>> localVarResponse = GetPlayerGamePPAWithHttpInfo(year, week, team, position, playerId, threshold, excludeGarbageTime);
             return localVarResponse.Data;
        }
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;PlayerGamePPA&gt;</returns>
        public ApiResponse< ICollection<PlayerGamePPA> > GetPlayerGamePPAWithHttpInfo (int? year = null, int? week = null, string team = null, string position = null, int? playerId = null, string threshold = null, bool? excludeGarbageTime = null)
        {
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>Task of ICollection&lt;PlayerGamePPA&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<PlayerGamePPA>> GetPlayerGamePPAAsync (int? year = null, int? week = null, string team = null, string position = null, int? playerId = null, string threshold = null, bool? excludeGarbageTime = null)
        {
             ApiResponse<ICollection<PlayerGamePPA>> localVarResponse = await GetPlayerGamePPAAsyncWithHttpInfo(year, week, team, position, playerId, threshold, excludeGarbageTime);
             return localVarResponse.Data;
        ...
        /// <param name="excludeGarbageTime">Filter to remove garbage time plays from calculations (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;PlayerGamePPA&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<PlayerGamePPA>>> GetPlayerGamePPAAsyncWithHttpInfo (int? year = null, int? week = null, string team = null, string position = null, int? playerId = null, string threshold = null, bool? excludeGarbageTime = null)
        {
        ...
        /// <summary>
        /// Get player season averages for Predicted Points Added (PPA) Predicted Points Added (PPA) by player season
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter (optional)</param>
        /// <param name="team">Team filter (optional)</param>
        ...
        /// <summary>
        /// Calculate Predicted Points Predicted Points
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="down">Down filter</param>
        /// <param name="distance">Distance filter</param>
        ...
        /// <summary>
        /// Get team averages for Predicted Points Added (PPA) Predicted Points Added (PPA)
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter (required if team not specified) (optional)</param>
        /// <param name="team">Team filter (required if year not specified) (optional)</param>
        ...
        /// <summary>
        /// Get win probability chart data Win probability data
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gameId">Game id filter</param>
        /// <param name="adjustForSpread">Toggles pregame spread adjustments (optional, default to true)</param>
        /// <returns>ICollection&lt;PlayWP&gt;</returns>
        public ICollection<PlayWP> GetWinProbabilityData (int? gameId, bool? adjustForSpread = null)
        {
             ApiResponse<ICollection<PlayWP>> localVarResponse = GetWinProbabilityDataWithHttpInfo(gameId, adjustForSpread);
             return localVarResponse.Data;
        }
        ...
        /// <param name="adjustForSpread">Toggles pregame spread adjustments (optional, default to true)</param>
        /// <returns>ApiResponse of ICollection&lt;PlayWP&gt;</returns>
        public ApiResponse< ICollection<PlayWP> > GetWinProbabilityDataWithHttpInfo (int? gameId, bool? adjustForSpread = null)
        {
            ...
            if (adjustForSpread != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "adjustForSpread", adjustForSpread)); // query parameter
        ...
        /// <param name="adjustForSpread">Toggles pregame spread adjustments (optional, default to true)</param>
        /// <returns>Task of ICollection&lt;PlayWP&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<PlayWP>> GetWinProbabilityDataAsync (int? gameId, bool? adjustForSpread = null)
        {
             ApiResponse<ICollection<PlayWP>> localVarResponse = await GetWinProbabilityDataAsyncWithHttpInfo(gameId, adjustForSpread);
             return localVarResponse.Data;
        ...
        /// <param name="adjustForSpread">Toggles pregame spread adjustments (optional, default to true)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;PlayWP&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<PlayWP>>> GetWinProbabilityDataAsyncWithHttpInfo (int? gameId, bool? adjustForSpread = null)
        {
            // verify the required parameter 'gameId' is set
            if (gameId == null)
                throw new ApiException(400, "Missing required parameter 'gameId' when calling MetricsApi->GetWinProbabilityData");
