...
namespace CFBSharp.Api
{
    ...
    public interface ITeamsApi : IApiAccessor
    {
        ...
        ApiResponse<ICollection<Player>> GetRosterWithHttpInfo (string team, int? year = null);
        /// <summary>
        ...
        /// <returns>ICollection&lt;TeamMatchup&gt;</returns>
        ...
        /// <param name="minYear">Minimum year (optional)</param>
        /// <param name="maxYear">Maximum year (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;TeamMatchup&gt;</returns>
        ApiResponse<ICollection<TeamMatchup>> GetTeamMatchupWithHttpInfo (string team1, string team2, int? minYear = null, int? maxYear = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ICollection<Player>> GetRosterAsync (string team, int? year = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<Player>>> GetRosterAsyncWithHttpInfo (string team, int? year = null);
        /// <summary>
        /// Get team talent rankings
        /// </summary>
        /// <remarks>
        ...
        /// <param name="minYear">Minimum year (optional)</param>
        /// <param name="maxYear">Maximum year (optional)</param>
        /// <returns>Task of ICollection&lt;TeamMatchup&gt;</returns>
        System.Threading.Tasks.Task<ICollection<TeamMatchup>> GetTeamMatchupAsync (string team1, string team2, int? minYear = null, int? maxYear = null);
        ...
        /// <param name="minYear">Minimum year (optional)</param>
        /// <param name="maxYear">Maximum year (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;TeamMatchup&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<ICollection<TeamMatchup>>> GetTeamMatchupAsyncWithHttpInfo (string team1, string team2, int? minYear = null, int? maxYear = null);
        /// <summary>
        /// Get team information
        /// </summary>
        /// <remarks>
    ...
    public partial class TeamsApi : ITeamsApi
    {
        ...
        /// <summary>
        /// Get list of major division teams for a given year Information on major division teams
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter (optional)</param>
        /// <returns>ICollection&lt;Team&gt;</returns>
        ...
        /// <summary>
        /// Get team roster Roster data
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="team">Team name</param>
        /// <param name="year">Season year (optional)</param>
        /// <returns>ICollection&lt;Player&gt;</returns>
        public ICollection<Player> GetRoster (string team, int? year = null)
        {
        ...
        /// <param name="year">Season year (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;Player&gt;</returns>
        public ApiResponse< ICollection<Player> > GetRosterWithHttpInfo (string team, int? year = null)
        {
            // verify the required parameter 'team' is set
            if (team == null)
                throw new ApiException(400, "Missing required parameter 'team' when calling TeamsApi->GetRoster");
        ...
        /// <param name="year">Season year (optional)</param>
        /// <returns>Task of ICollection&lt;Player&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<Player>> GetRosterAsync (string team, int? year = null)
        {
        ...
        /// <param name="year">Season year (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;Player&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<Player>>> GetRosterAsyncWithHttpInfo (string team, int? year = null)
        {
            // verify the required parameter 'team' is set
            if (team == null)
                throw new ApiException(400, "Missing required parameter 'team' when calling TeamsApi->GetRoster");
        ...
        /// <summary>
        /// Get team talent rankings Team talent composite
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter (optional)</param>
        /// <returns>ICollection&lt;TeamTalent&gt;</returns>
        ...
        /// <summary>
        /// Get matchup history Matchup history
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="team1">First team</param>
        /// <param name="team2">Second team</param>
        ...
        /// <param name="maxYear">Maximum year (optional)</param>
        /// <returns>ICollection&lt;TeamMatchup&gt;</returns>
        public ICollection<TeamMatchup> GetTeamMatchup (string team1, string team2, int? minYear = null, int? maxYear = null)
        {
             ApiResponse<ICollection<TeamMatchup>> localVarResponse = GetTeamMatchupWithHttpInfo(team1, team2, minYear, maxYear);
             return localVarResponse.Data;
        }
        ...
        /// <param name="maxYear">Maximum year (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;TeamMatchup&gt;</returns>
        public ApiResponse< ICollection<TeamMatchup> > GetTeamMatchupWithHttpInfo (string team1, string team2, int? minYear = null, int? maxYear = null)
        {
            ...
            return new ApiResponse<ICollection<TeamMatchup>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (ICollection<TeamMatchup>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<TeamMatchup>)));
        }
        ...
        /// <param name="maxYear">Maximum year (optional)</param>
        /// <returns>Task of ICollection&lt;TeamMatchup&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<TeamMatchup>> GetTeamMatchupAsync (string team1, string team2, int? minYear = null, int? maxYear = null)
        {
             ApiResponse<ICollection<TeamMatchup>> localVarResponse = await GetTeamMatchupAsyncWithHttpInfo(team1, team2, minYear, maxYear);
             return localVarResponse.Data;
        ...
        /// <param name="maxYear">Maximum year (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;TeamMatchup&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<TeamMatchup>>> GetTeamMatchupAsyncWithHttpInfo (string team1, string team2, int? minYear = null, int? maxYear = null)
        {
            // verify the required parameter 'team1' is set
            if (team1 == null)
                throw new ApiException(400, "Missing required parameter 'team1' when calling TeamsApi->GetTeamMatchup");
