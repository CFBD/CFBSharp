...
namespace CFBSharp.Api
{
    ...
    public interface IPlaysApi : IApiAccessor
    {
        ...
        /// <returns>LivePlayByPlay</returns>
        ...
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Game id</param>
        /// <returns>ApiResponse of LivePlayByPlay</returns>
        ApiResponse<LivePlayByPlay> GetLivePlaysWithHttpInfo (int? id);
        /// <summary>
        ...
        ApiResponse<ICollection<Play>> GetPlaysWithHttpInfo (int? year, int? week, string seasonType = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, int? playType = null, string classification = null);
        ...
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Game id</param>
        /// <returns>Task of LivePlayByPlay</returns>
        System.Threading.Tasks.Task<LivePlayByPlay> GetLivePlaysAsync (int? id);
        ...
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Game id</param>
        /// <returns>Task of ApiResponse (LivePlayByPlay)</returns>
        System.Threading.Tasks.Task<ApiResponse<LivePlayByPlay>> GetLivePlaysAsyncWithHttpInfo (int? id);
        /// <summary>
        /// Types of player play stats
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ICollection<Play>> GetPlaysAsync (int? year, int? week, string seasonType = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, int? playType = null, string classification = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<Play>>> GetPlaysAsyncWithHttpInfo (int? year, int? week, string seasonType = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, int? playType = null, string classification = null);
    ...
    public partial class PlaysApi : IPlaysApi
    {
        ...
        /// <summary>
        /// Live metrics and PBP (Patreon only) Get live metrics and PBP
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Game id</param>
        /// <returns>LivePlayByPlay</returns>
        public LivePlayByPlay GetLivePlays (int? id)
        {
             ApiResponse<LivePlayByPlay> localVarResponse = GetLivePlaysWithHttpInfo(id);
        ...
        /// <param name="id">Game id</param>
        /// <returns>ApiResponse of LivePlayByPlay</returns>
        public ApiResponse< LivePlayByPlay > GetLivePlaysWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PlaysApi->GetLivePlays");

            var localVarPath = "./live/plays";
            ...
            {
                Exception exception = ExceptionFactory("GetLivePlays", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<LivePlayByPlay>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (LivePlayByPlay) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(LivePlayByPlay)));
        }
        ...
        /// <param name="id">Game id</param>
        /// <returns>Task of LivePlayByPlay</returns>
        public async System.Threading.Tasks.Task<LivePlayByPlay> GetLivePlaysAsync (int? id)
        {
             ApiResponse<LivePlayByPlay> localVarResponse = await GetLivePlaysAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">Game id</param>
        /// <returns>Task of ApiResponse (LivePlayByPlay)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LivePlayByPlay>> GetLivePlaysAsyncWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PlaysApi->GetLivePlays");
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>ICollection&lt;Play&gt;</returns>
        public ICollection<Play> GetPlays (int? year, int? week, string seasonType = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, int? playType = null, string classification = null)
        {
             ApiResponse<ICollection<Play>> localVarResponse = GetPlaysWithHttpInfo(year, week, seasonType, team, offense, defense, conference, offenseConference, defenseConference, playType, classification);
             return localVarResponse.Data;
        }
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;Play&gt;</returns>
        public ApiResponse< ICollection<Play> > GetPlaysWithHttpInfo (int? year, int? week, string seasonType = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, int? playType = null, string classification = null)
        {
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>Task of ICollection&lt;Play&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<Play>> GetPlaysAsync (int? year, int? week, string seasonType = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, int? playType = null, string classification = null)
        {
             ApiResponse<ICollection<Play>> localVarResponse = await GetPlaysAsyncWithHttpInfo(year, week, seasonType, team, offense, defense, conference, offenseConference, defenseConference, playType, classification);
             return localVarResponse.Data;
        ...
        /// <param name="classification">Division classification filter (fbs/fcs/ii/iii) (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;Play&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<Play>>> GetPlaysAsyncWithHttpInfo (int? year, int? week, string seasonType = null, string team = null, string offense = null, string defense = null, string conference = null, string offenseConference = null, string defenseConference = null, int? playType = null, string classification = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling PlaysApi->GetPlays");
