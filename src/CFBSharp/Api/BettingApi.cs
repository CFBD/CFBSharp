...
namespace CFBSharp.Api
{
    ...
    public interface IBettingApi : IApiAccessor
    {
        ...
        ApiResponse<ICollection<GameLines>> GetLinesWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string home = null, string away = null, string conference = null);
        ...
        System.Threading.Tasks.Task<ICollection<GameLines>> GetLinesAsync (int? year, int? week = null, string seasonType = null, string team = null, string home = null, string away = null, string conference = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<GameLines>>> GetLinesAsyncWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string home = null, string away = null, string conference = null);
    ...
    public partial class BettingApi : IBettingApi
    {
        ...
        /// <summary>
        /// Get betting line information Closing betting lines
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year/season filter for games</param>
        /// <param name="week">Week filter (optional)</param>
        ...
        /// <param name="conference">Conference abbreviation filter (optional)</param>
        /// <returns>ICollection&lt;GameLines&gt;</returns>
        public ICollection<GameLines> GetLines (int? year, int? week = null, string seasonType = null, string team = null, string home = null, string away = null, string conference = null)
        {
             ApiResponse<ICollection<GameLines>> localVarResponse = GetLinesWithHttpInfo(year, week, seasonType, team, home, away, conference);
        ...
        /// <param name="conference">Conference abbreviation filter (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;GameLines&gt;</returns>
        public ApiResponse< ICollection<GameLines> > GetLinesWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string home = null, string away = null, string conference = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling BettingApi->GetLines");
        ...
        /// <param name="conference">Conference abbreviation filter (optional)</param>
        /// <returns>Task of ICollection&lt;GameLines&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<GameLines>> GetLinesAsync (int? year, int? week = null, string seasonType = null, string team = null, string home = null, string away = null, string conference = null)
        {
             ApiResponse<ICollection<GameLines>> localVarResponse = await GetLinesAsyncWithHttpInfo(year, week, seasonType, team, home, away, conference);
             return localVarResponse.Data;
        ...
        /// <param name="conference">Conference abbreviation filter (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;GameLines&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<GameLines>>> GetLinesAsyncWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string home = null, string away = null, string conference = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling BettingApi->GetLines");
