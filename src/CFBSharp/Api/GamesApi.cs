...
namespace CFBSharp.Api
{
    ...
    public interface IGamesApi : IApiAccessor
    {
        ...
        ApiResponse<ICollection<GameWeather>> GetGameWeatherWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string conference = null);
        /// <summary>
        /// Games and results
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ICollection<GameWeather>> GetGameWeatherAsync (int? year, int? week = null, string seasonType = null, string team = null, string conference = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<GameWeather>>> GetGameWeatherAsyncWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string conference = null);
        /// <summary>
        /// Games and results
        /// </summary>
        /// <remarks>
    ...
    public partial class GamesApi : IGamesApi
    {
        ...
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>ICollection&lt;GameWeather&gt;</returns>
        public ICollection<GameWeather> GetGameWeather (int? year, int? week = null, string seasonType = null, string team = null, string conference = null)
        {
             ApiResponse<ICollection<GameWeather>> localVarResponse = GetGameWeatherWithHttpInfo(year, week, seasonType, team, conference);
             return localVarResponse.Data;
        }
        ...
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;GameWeather&gt;</returns>
        public ApiResponse< ICollection<GameWeather> > GetGameWeatherWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string conference = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling GamesApi->GetGameWeather");
        ...
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>Task of ICollection&lt;GameWeather&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<GameWeather>> GetGameWeatherAsync (int? year, int? week = null, string seasonType = null, string team = null, string conference = null)
        {
             ApiResponse<ICollection<GameWeather>> localVarResponse = await GetGameWeatherAsyncWithHttpInfo(year, week, seasonType, team, conference);
             return localVarResponse.Data;
        ...
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;GameWeather&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<GameWeather>>> GetGameWeatherAsyncWithHttpInfo (int? year, int? week = null, string seasonType = null, string team = null, string conference = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling GamesApi->GetGameWeather");
