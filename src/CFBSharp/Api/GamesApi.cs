...
namespace CFBSharp.Api
{
    ...
    public interface IGamesApi : IApiAccessor
    {
        ...
        /// <returns>ICollection&lt;BoxScore&gt;</returns>
        ...
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gameId">Game id parameters</param>
        /// <returns>ApiResponse of ICollection&lt;BoxScore&gt;</returns>
        ApiResponse<ICollection<BoxScore>> GetAdvancedBoxScoreWithHttpInfo (int? gameId);
        /// <summary>
        ...
        /// <param name="year2">Week filter (optional)</param>
        ...
        ApiResponse<ICollection<GameMedia>> GetGameMediaWithHttpInfo (int? year, int? year2 = null, int? seasonType = null, string team = null, string conference = null, string mediaType = null);
        /// <summary>
        ...
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gameId">Game id parameters</param>
        /// <returns>Task of ICollection&lt;BoxScore&gt;</returns>
        System.Threading.Tasks.Task<ICollection<BoxScore>> GetAdvancedBoxScoreAsync (int? gameId);
        ...
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gameId">Game id parameters</param>
        /// <returns>Task of ApiResponse (ICollection&lt;BoxScore&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<ICollection<BoxScore>>> GetAdvancedBoxScoreAsyncWithHttpInfo (int? gameId);
        /// <summary>
        /// Get game media information (TV, radio, etc)
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ICollection<GameMedia>> GetGameMediaAsync (int? year, int? year2 = null, int? seasonType = null, string team = null, string conference = null, string mediaType = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<GameMedia>>> GetGameMediaAsyncWithHttpInfo (int? year, int? year2 = null, int? seasonType = null, string team = null, string conference = null, string mediaType = null);
        /// <summary>
        /// Get game information
        /// </summary>
        /// <remarks>
    ...
    public partial class GamesApi : IGamesApi
    {
        ...
        /// <summary>
        /// Get advanced box score Advanced box score
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gameId">Game id parameters</param>
        /// <returns>ICollection&lt;BoxScore&gt;</returns>
        public ICollection<BoxScore> GetAdvancedBoxScore (int? gameId)
        {
             ApiResponse<ICollection<BoxScore>> localVarResponse = GetAdvancedBoxScoreWithHttpInfo(gameId);
        ...
        /// <param name="gameId">Game id parameters</param>
        /// <returns>ApiResponse of ICollection&lt;BoxScore&gt;</returns>
        public ApiResponse< ICollection<BoxScore> > GetAdvancedBoxScoreWithHttpInfo (int? gameId)
        {
            ...
            return new ApiResponse<ICollection<BoxScore>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (ICollection<BoxScore>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<BoxScore>)));
        }
        ...
        /// <param name="gameId">Game id parameters</param>
        /// <returns>Task of ICollection&lt;BoxScore&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<BoxScore>> GetAdvancedBoxScoreAsync (int? gameId)
        {
             ApiResponse<ICollection<BoxScore>> localVarResponse = await GetAdvancedBoxScoreAsyncWithHttpInfo(gameId);
             return localVarResponse.Data;
        ...
        /// <param name="gameId">Game id parameters</param>
        /// <returns>Task of ApiResponse (ICollection&lt;BoxScore&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<BoxScore>>> GetAdvancedBoxScoreAsyncWithHttpInfo (int? gameId)
        {
            // verify the required parameter 'gameId' is set
            if (gameId == null)
                throw new ApiException(400, "Missing required parameter 'gameId' when calling GamesApi->GetAdvancedBoxScore");
        ...
        /// <summary>
        /// Get game media information (TV, radio, etc) Game media information (TV, radio, etc)
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter</param>
        /// <param name="year2">Week filter (optional)</param>
        ...
        /// <param name="mediaType">Media type filter (tv, radio, web, ppv, or mobile) (optional)</param>
        /// <returns>ICollection&lt;GameMedia&gt;</returns>
        public ICollection<GameMedia> GetGameMedia (int? year, int? year2 = null, int? seasonType = null, string team = null, string conference = null, string mediaType = null)
        {
             ApiResponse<ICollection<GameMedia>> localVarResponse = GetGameMediaWithHttpInfo(year, year2, seasonType, team, conference, mediaType);
             return localVarResponse.Data;
        }
        ...
        /// <param name="mediaType">Media type filter (tv, radio, web, ppv, or mobile) (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;GameMedia&gt;</returns>
        public ApiResponse< ICollection<GameMedia> > GetGameMediaWithHttpInfo (int? year, int? year2 = null, int? seasonType = null, string team = null, string conference = null, string mediaType = null)
        {
            ...
            if (year2 != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "year", year2)); // query parameter
        ...
        /// <param name="mediaType">Media type filter (tv, radio, web, ppv, or mobile) (optional)</param>
        /// <returns>Task of ICollection&lt;GameMedia&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<GameMedia>> GetGameMediaAsync (int? year, int? year2 = null, int? seasonType = null, string team = null, string conference = null, string mediaType = null)
        {
             ApiResponse<ICollection<GameMedia>> localVarResponse = await GetGameMediaAsyncWithHttpInfo(year, year2, seasonType, team, conference, mediaType);
             return localVarResponse.Data;
        ...
        /// <param name="mediaType">Media type filter (tv, radio, web, ppv, or mobile) (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;GameMedia&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<GameMedia>>> GetGameMediaAsyncWithHttpInfo (int? year, int? year2 = null, int? seasonType = null, string team = null, string conference = null, string mediaType = null)
        {
            // verify the required parameter 'year' is set
            if (year == null)
                throw new ApiException(400, "Missing required parameter 'year' when calling GamesApi->GetGameMedia");
        ...
        /// <summary>
        /// Get game information Game results
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year/season filter for games</param>
        /// <param name="week">Week filter (optional)</param>
        ...
        /// <summary>
        /// Get player statistics by game Player game stats
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year/season filter for games</param>
        /// <param name="week">Week filter (optional)</param>
        ...
        /// <summary>
        /// Get team statistics by game Team game stats
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year/season filter for games</param>
        /// <param name="week">Week filter (optional)</param>
        ...
        /// <summary>
        /// Get records by year Team records by year
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Year filter (optional)</param>
        /// <param name="team">Team filter (optional)</param>
