...
namespace CFBSharp.Api
{
    ...
    public interface IRatingsApi : IApiAccessor
    {
        ...
        /// <param name="seasonType">Maximum season type to consider (defaults to regular if week is specified else defaults to postseason) (optional)</param>
        ...
        /// <param name="team">Team filter (optional)</param>
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>ICollection&lt;TeamFPIRating&gt;</returns>
        ...
        /// <param name="team">Team filter (optional)</param>
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;TeamFPIRating&gt;</returns>
        ApiResponse<ICollection<TeamFPIRating>> GetFPIRatingsWithHttpInfo (int? year = null, string team = null, string conference = null);
        /// <summary>
        ...
        /// <param name="team">Team filter (optional)</param>
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>Task of ICollection&lt;TeamFPIRating&gt;</returns>
        System.Threading.Tasks.Task<ICollection<TeamFPIRating>> GetFPIRatingsAsync (int? year = null, string team = null, string conference = null);
        ...
        /// <param name="team">Team filter (optional)</param>
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;TeamFPIRating&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<ICollection<TeamFPIRating>>> GetFPIRatingsAsyncWithHttpInfo (int? year = null, string team = null, string conference = null);
        /// <summary>
        /// Historical SP+ ratings
        /// </summary>
        /// <remarks>
    ...
    public partial class RatingsApi : IRatingsApi
    {
        ...
        /// <summary>
        /// Historical FPI ratings FPI rating data
        /// </summary>
        /// <exception cref="CFBSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="year">Season filter (optional)</param>
        /// <param name="team">Team filter (optional)</param>
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>ICollection&lt;TeamFPIRating&gt;</returns>
        public ICollection<TeamFPIRating> GetFPIRatings (int? year = null, string team = null, string conference = null)
        {
             ApiResponse<ICollection<TeamFPIRating>> localVarResponse = GetFPIRatingsWithHttpInfo(year, team, conference);
             return localVarResponse.Data;
        }
        ...
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;TeamFPIRating&gt;</returns>
        public ApiResponse< ICollection<TeamFPIRating> > GetFPIRatingsWithHttpInfo (int? year = null, string team = null, string conference = null)
        {

            var localVarPath = "./ratings/fpi";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetFPIRatings", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ICollection<TeamFPIRating>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (ICollection<TeamFPIRating>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<TeamFPIRating>)));
        }
        ...
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>Task of ICollection&lt;TeamFPIRating&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<TeamFPIRating>> GetFPIRatingsAsync (int? year = null, string team = null, string conference = null)
        {
             ApiResponse<ICollection<TeamFPIRating>> localVarResponse = await GetFPIRatingsAsyncWithHttpInfo(year, team, conference);
             return localVarResponse.Data;
        ...
        /// <param name="conference">Conference filter (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;TeamFPIRating&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<TeamFPIRating>>> GetFPIRatingsAsyncWithHttpInfo (int? year = null, string team = null, string conference = null)
        {
