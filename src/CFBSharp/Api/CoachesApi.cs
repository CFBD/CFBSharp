...
namespace CFBSharp.Api
{
    ...
    public interface ICoachesApi : IApiAccessor
    {
        ...
        /// <returns>ICollection&lt;Coach&gt;</returns>
        ...
        /// <param name="minYear">Minimum year filter (inclusive) (optional)</param>
        /// <param name="maxYear">Maximum year filter (inclusive) (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;Coach&gt;</returns>
        ApiResponse<ICollection<Coach>> GetCoachesWithHttpInfo (string firstName = null, string lastName = null, string team = null, int? year = null, int? minYear = null, int? maxYear = null);
        ...
        /// <param name="minYear">Minimum year filter (inclusive) (optional)</param>
        /// <param name="maxYear">Maximum year filter (inclusive) (optional)</param>
        /// <returns>Task of ICollection&lt;Coach&gt;</returns>
        System.Threading.Tasks.Task<ICollection<Coach>> GetCoachesAsync (string firstName = null, string lastName = null, string team = null, int? year = null, int? minYear = null, int? maxYear = null);
        ...
        /// <param name="minYear">Minimum year filter (inclusive) (optional)</param>
        /// <param name="maxYear">Maximum year filter (inclusive) (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;Coach&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<ICollection<Coach>>> GetCoachesAsyncWithHttpInfo (string firstName = null, string lastName = null, string team = null, int? year = null, int? minYear = null, int? maxYear = null);
    ...
    public partial class CoachesApi : ICoachesApi
    {
        ...
        /// <param name="maxYear">Maximum year filter (inclusive) (optional)</param>
        /// <returns>ICollection&lt;Coach&gt;</returns>
        public ICollection<Coach> GetCoaches (string firstName = null, string lastName = null, string team = null, int? year = null, int? minYear = null, int? maxYear = null)
        {
             ApiResponse<ICollection<Coach>> localVarResponse = GetCoachesWithHttpInfo(firstName, lastName, team, year, minYear, maxYear);
        ...
        /// <param name="maxYear">Maximum year filter (inclusive) (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;Coach&gt;</returns>
        public ApiResponse< ICollection<Coach> > GetCoachesWithHttpInfo (string firstName = null, string lastName = null, string team = null, int? year = null, int? minYear = null, int? maxYear = null)
        {
            ...
            return new ApiResponse<ICollection<Coach>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (ICollection<Coach>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<Coach>)));
        }
        ...
        /// <param name="maxYear">Maximum year filter (inclusive) (optional)</param>
        /// <returns>Task of ICollection&lt;Coach&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<Coach>> GetCoachesAsync (string firstName = null, string lastName = null, string team = null, int? year = null, int? minYear = null, int? maxYear = null)
        {
             ApiResponse<ICollection<Coach>> localVarResponse = await GetCoachesAsyncWithHttpInfo(firstName, lastName, team, year, minYear, maxYear);
             return localVarResponse.Data;
        ...
        /// <param name="maxYear">Maximum year filter (inclusive) (optional)</param>
        /// <returns>Task of ApiResponse (ICollection&lt;Coach&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<Coach>>> GetCoachesAsyncWithHttpInfo (string firstName = null, string lastName = null, string team = null, int? year = null, int? minYear = null, int? maxYear = null)
        {
