...
namespace CFBSharp.Model
{
    ...
    public partial class Game :  IEquatable<Game>
    {
        ...
        public Game(int? id = default(int?), int? season = default(int?), int? week = default(int?), string seasonType = default(string), string startDate = default(string), bool? startTimeTbd = default(bool?), bool? neutralSite = default(bool?), bool? conferenceGame = default(bool?), int? attendance = default(int?), int? venueId = default(int?), string venue = default(string), int? homeId = default(int?), string homeTeam = default(string), string homeConference = default(string), string homeDivision = default(string), int? homePoints = default(int?), List<int?> homeLineScores = default(List<int?>), decimal? homePostWinProb = default(decimal?), int? homePregameElo = default(int?), int? homePostgameElo = default(int?), int? awayId = default(int?), string awayTeam = default(string), string awayConference = default(string), string awayDivision = default(string), int? awayPoints = default(int?), List<int?> awayLineScores = default(List<int?>), decimal? awayPostWinProb = default(decimal?), int? awayPregameElo = default(int?), int? awayPostgameElo = default(int?), decimal? excitementIndex = default(decimal?), string highlights = default(string), string notes = default(string))
        {
            this.Id = id;
            this.Season = season;
            this.Week = week;
