...
namespace CFBSharp.Model
{
    ...
    public partial class TeamRecord :  IEquatable<TeamRecord>
    {
        ...
        public TeamRecord(int? year = default(int?), string team = default(string), string conference = default(string), string division = default(string), Object total = default(Object), Object conferenceGames = default(Object), Object homeGames = default(Object), Object awayGames = default(Object))
        {
            this.Year = year;
            this.Team = team;
