...
namespace CFBSharp.Model
{
    ...
    public partial class Team :  IEquatable<Team>
    {
        ...
        public Team(int? id = default(int?), string school = default(string), string mascot = default(string), string abbreviation = default(string), string altName1 = default(string), string altName2 = default(string), string altName3 = default(string), string classification = default(string), string conference = default(string), string division = default(string), string color = default(string), string altColor = default(string), List<string> logos = default(List<string>), string twitter = default(string), TeamLocation location = default(TeamLocation))
        {
            this.Id = id;
            this.School = school;
            this.Mascot = mascot;
