...
namespace CFBSharp.Model
{
    ...
    public partial class Play :  IEquatable<Play>
    {
        ...
        /// <param name="homeTimeouts">homeTimeouts.</param>
        /// <param name="awayTimeouts">awayTimeouts.</param>
        ...
        /// <summary>
        /// Gets or Sets HomeTimeouts
        /// </summary>
        [DataMember(Name="home_timeouts", EmitDefaultValue=false)]
        public int? HomeTimeouts { get; set; }

        /// <summary>
        /// Gets or Sets AwayTimeouts
        /// </summary>
        [DataMember(Name="away_timeouts", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HomeTimeouts: ").Append(HomeTimeouts).Append("\n");
            sb.Append("  AwayTimeouts: ").Append(AwayTimeouts).Append("\n");
        ...
        public bool Equals(Play input)
        {
            ...
            return 
                ...
                (
                    this.HomeTimeouts == input.HomeTimeouts ||
                    (this.HomeTimeouts != null &&
                    this.HomeTimeouts.Equals(input.HomeTimeouts))
                ) && 
                (
                    this.AwayTimeouts == input.AwayTimeouts ||
                    (this.AwayTimeouts != null &&
                    this.AwayTimeouts.Equals(input.AwayTimeouts))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HomeTimeouts != null)
                    hashCode = hashCode * 59 + this.HomeTimeouts.GetHashCode();
                if (this.AwayTimeouts != null)
                    hashCode = hashCode * 59 + this.AwayTimeouts.GetHashCode();
