...
namespace CFBSharp.Model
{
    ...
    public partial class ScoreboardGame :  IEquatable<ScoreboardGame>
    {
        ...
        public ScoreboardGame(int? id = default(int?), string startDate = default(string), bool? startTimeTBD = default(bool?), string tv = default(string), bool? neutralSite = default(bool?), bool? conferenceGame = default(bool?), string status = default(string), int? period = default(int?), string clock = default(string), string situation = default(string), string possession = default(string), ScoreboardGameVenue venue = default(ScoreboardGameVenue), ScoreboardGameHomeTeam homeTeam = default(ScoreboardGameHomeTeam), ScoreboardGameHomeTeam awayTeam = default(ScoreboardGameHomeTeam), ScoreboardGameWeather weather = default(ScoreboardGameWeather), ScoreboardGameBetting betting = default(ScoreboardGameBetting))
        {
            this.Id = id;
        ...
        public bool Equals(ScoreboardGame input)
        {
            ...
            return 
                ...
                (
                    this.Situation == input.Situation ||
                    (this.Situation != null &&
                    this.Situation.Equals(input.Situation))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Situation != null)
                    hashCode = hashCode * 59 + this.Situation.GetHashCode();
