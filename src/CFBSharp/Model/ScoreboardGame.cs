...
namespace CFBSharp.Model
{
    ...
    public partial class ScoreboardGame :  IEquatable<ScoreboardGame>
    {
        ...
        public ScoreboardGame(int? id = default(int?), string startDate = default(string), string tv = default(string), bool? neutralSite = default(bool?), bool? conferenceGame = default(bool?), string status = default(string), int? period = default(int?), string clock = default(string), Object venue = default(Object), Object homeTeam = default(Object), Object awayTeam = default(Object), Object weather = default(Object), Object betting = default(Object))
        {
            this.Id = id;
