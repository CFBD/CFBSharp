...
namespace CFBSharp.Model
{
    ...
    public partial class AdvancedSeasonStat :  IEquatable<AdvancedSeasonStat>
    {
        ...
        public AdvancedSeasonStat(int? season = default(int?), string team = default(string), string conference = default(string), Object offense = default(Object), Object defense = default(Object))
        {
            this.Season = season;
            this.Team = team;
