...
namespace CFBSharp.Model
{
    ...
    public partial class TeamSPRatingOffense :  IEquatable<TeamSPRatingOffense>
    {
        ...
        public TeamSPRatingOffense(decimal? rating = default(decimal?), decimal? success = default(decimal?), decimal? explosiveness = default(decimal?), decimal? rushing = default(decimal?), decimal? passing = default(decimal?), decimal? standardDowns = default(decimal?), decimal? passingDowns = default(decimal?), decimal? runRate = default(decimal?), decimal? pace = default(decimal?))
        {
            this.Rating = rating;
