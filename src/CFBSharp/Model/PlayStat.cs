...
namespace CFBSharp.Model
{
    ...
    public partial class PlayStat :  IEquatable<PlayStat>
    {
        ...
        /// <param name="secondsRemaining">secondsRemaining.</param>
        ...
        public PlayStat(int? gameId = default(int?), int? season = default(int?), int? week = default(int?), string opponent = default(string), int? teamScore = default(int?), int? opponentScore = default(int?), int? driveId = default(int?), int? playId = default(int?), int? period = default(int?), int? secondsRemaining = default(int?), int? yardsToGoal = default(int?), int? down = default(int?), int? distance = default(int?), int? athleteId = default(int?), string athleteName = default(string), string statType = default(string), int? stat = default(int?))
        {
            this.GameId = gameId;
            this.Season = season;
            this.Week = week;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SecondsRemaining: ").Append(SecondsRemaining).Append("\n");
