...
namespace CFBSharp.Model
{
    ...
    public partial class PlayStat :  IEquatable<PlayStat>
    {
        ...
        public PlayStat(int? gameId = default(int?), int? season = default(int?), int? week = default(int?), string team = default(string), string conference = default(string), string opponent = default(string), int? teamScore = default(int?), int? opponentScore = default(int?), long? driveId = default(int?), long? playId = default(long?), int? period = default(int?), Object clock = default(Object), int? yardsToGoal = default(int?), int? down = default(int?), int? distance = default(int?), int? athleteId = default(int?), string athleteName = default(string), string statType = default(string), int? stat = default(int?))
        {
            this.GameId = gameId;
            this.Season = season;
            this.Week = week;
