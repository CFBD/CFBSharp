...
namespace CFBSharp.Model
{
    ...
    public partial class AdvancedSeasonStatOffense :  IEquatable<AdvancedSeasonStatOffense>
    {
        ...
        /// </summary>
        [DataMember(Name="totalOpportunies", EmitDefaultValue=false)]
        ...
        public bool Equals(AdvancedSeasonStatOffense input)
        {
            ...
            return 
                ...
                (
                    this.TotalOpportunies == input.TotalOpportunies ||
                    (this.TotalOpportunies != null &&
                    this.TotalOpportunies.Equals(input.TotalOpportunies))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TotalOpportunies != null)
                    hashCode = hashCode * 59 + this.TotalOpportunies.GetHashCode();
