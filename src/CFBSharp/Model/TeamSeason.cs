...
namespace CFBSharp.Model
{
    ...
    public partial class TeamSeason :  IEquatable<TeamSeason>
    {
        ...
        public TeamSeason(string school = default(string), string year = default(string), int? games = default(int?), int? wins = default(int?), int? losses = default(int?), int? ties = default(int?), int? preseasonRank = default(int?), int? postseasonRank = default(int?), decimal? srs = default(decimal?), decimal? spOverall = default(decimal?), decimal? spOffense = default(decimal?), decimal? spDefense = default(decimal?))
        {
            this.School = school;
            this.Year = year;
            this.Games = games;
