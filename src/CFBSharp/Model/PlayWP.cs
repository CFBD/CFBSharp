...
namespace CFBSharp.Model
{
    ...
    public partial class PlayWP :  IEquatable<PlayWP>
    {
        ...
        public PlayWP(int? playId = default(int?), string playText = default(string), int? homeId = default(int?), string home = default(string), int? awayId = default(int?), string away = default(string), decimal? spread = default(decimal?), bool? homeBall = default(bool?), int? homeScore = default(int?), int? awayScore = default(int?), int? timeRemaining = default(int?), int? yardLine = default(int?), int? down = default(int?), int? distance = default(int?), bool? homeWinner = default(bool?), decimal? homeWinProb = default(decimal?), int? playNumber = default(int?))
        {
            this.PlayId = playId;
        ...
        /// </summary>
        [DataMember(Name="homeWinner", EmitDefaultValue=false)]
        ...
        public bool Equals(PlayWP input)
        {
            ...
            return 
                ...
                (
                    this.HomeWinner == input.HomeWinner ||
                    (this.HomeWinner != null &&
                    this.HomeWinner.Equals(input.HomeWinner))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HomeWinner != null)
                    hashCode = hashCode * 59 + this.HomeWinner.GetHashCode();
