...
namespace CFBSharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BoxScorePlayersUsage :  IEquatable<BoxScorePlayersUsage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BoxScorePlayersUsage" /> class.
        /// </summary>
        ...
        public BoxScorePlayersUsage(string player = default(string), string team = default(string), string position = default(string), decimal? total = default(decimal?), decimal? quarter1 = default(decimal?), decimal? quarter2 = default(decimal?), decimal? quarter3 = default(decimal?), decimal? quarter4 = default(decimal?), decimal? rushing = default(decimal?), decimal? passing = default(decimal?))
        {
            this.Player = player;
            this.Team = team;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BoxScorePlayersUsage {\n");
        ...
        {
            return this.Equals(input as BoxScorePlayersUsage);
        }

        /// <summary>
        /// Returns true if BoxScorePlayersUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of BoxScorePlayersUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BoxScorePlayersUsage input)
        {
            if (input == null)
                return false;
