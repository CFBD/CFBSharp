...
namespace CFBSharp.Model
{
    ...
    public partial class BoxScoreTeams :  IEquatable<BoxScoreTeams>
    {
        ...
        public BoxScoreTeams(decimal? plays = default(decimal?), List<BoxScoreTeamsPpa> ppa = default(List<BoxScoreTeamsPpa>), List<BoxScoreTeamsPpa> cumulativePpa = default(List<BoxScoreTeamsPpa>), List<BoxScoreTeamsSuccessRates> successRates = default(List<BoxScoreTeamsSuccessRates>), List<BoxScoreTeamsExplosiveness> explosiveness = default(List<BoxScoreTeamsExplosiveness>), List<BoxScoreTeamsRushing> rushing = default(List<BoxScoreTeamsRushing>), List<BoxScoreTeamsHavoc> havoc = default(List<BoxScoreTeamsHavoc>), List<BoxScoreTeamsScoringOpportunities> scoringOpportunities = default(List<BoxScoreTeamsScoringOpportunities>), List<BoxScoreTeamsFieldPosition> fieldPosition = default(List<BoxScoreTeamsFieldPosition>))
        {
            this.Plays = plays;
            this.Ppa = ppa;
