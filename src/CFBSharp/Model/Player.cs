...
namespace CFBSharp.Model
{
    ...
    public partial class Player :  IEquatable<Player>
    {
        ...
        public Player(int? id = default(int?), string firstName = default(string), string lastName = default(string), string team = default(string), int? height = default(int?), int? weight = default(int?), int? jersey = default(int?), int? year = default(int?), string position = default(string), string city = default(string), string state = default(string), string country = default(string), decimal? homeLatitude = default(decimal?), decimal? homeLongitude = default(decimal?), string homeCountyFips = default(string))
        {
            this.Id = id;
