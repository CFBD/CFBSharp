...
namespace CFBSharp.Model
{
    ...
    public partial class PortalPlayer :  IEquatable<PortalPlayer>
    {
        ...
        public PortalPlayer(int? id = default(int?), int? season = default(int?), string firstName = default(string), string lastName = default(string), string position = default(string), string origin = default(string), string destination = default(string), string transferDate = default(string), decimal? rating = default(decimal?), int? stars = default(int?), string eligibility = default(string))
        {
            this.Id = id;
            this.Season = season;
